package com.bank.bian.cardnetworkparticipantservices.model;
...
/**
 * The BIAN control record for this service domain: "Card Network Membership Operating Session".
 *
 ...
 * to its asset type (Card Network Membership). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Network Membership Operating Session";
