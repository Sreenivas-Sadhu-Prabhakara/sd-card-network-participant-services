...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Card Network Participant Services");
    ...
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/card-network-membership-operating-session/initiate",
